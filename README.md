A simple Chat web application portal that uses Websockets to establish the open connection between users and secure a realtime connection to deliver messages both ways,
